export const carouselData = {
  ...
  contentCallToAction: "Saiba Mais",
  contents: [
    {
      title: "O que nossos clientes dizem",
      description: "Nossos clientes ficam felizes com nossos serviços há vários anos agora. Veja avaliações reais de nossos clientes.",
    ...
    {
      title: "Nosso time",
      description: "Nossa equipe é composta pelos melhores especialistas da indústria, conheça-os",
      image: "./assets/teamwork.jpg",
    },
    {
      title: "Infraestrutura",
      description: "Saiba mais sobre o hardware e software usados ​​para seu serviço",
